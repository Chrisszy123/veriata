...
const Trending = () => {
  return (
    <>
      {/* Start Tending Item */}
      <div
        className="cs-slider cs-style1 cs-gap-24 wow fadeIn"
      ...
      >
        ...
        >
          <div className="cs-slider_wrapper ">
            <div className="cs-slide">
              <a href="#" className="cs-image_box cs-style1">
                <img src="assets/img/product1.svg" alt="Product" />
              </a>
            </div>
            {/* .cs-slide */}
            <div className="cs-slide">
              <a href="#" className="cs-image_box cs-style1">
                <img src="assets/img/product2.svg" alt="Product" />
              </a>
            </div>
            {/* .cs-slide */}
            <div className="cs-slide">
              <a href="#" className="cs-image_box cs-style1">
                <img src="assets/img/product3.svg" alt="Product" />
              </a>
            </div>
            {/* .cs-slide */}
            <div className="cs-slide">
              <a href="#" className="cs-image_box cs-style1">
                <img src="assets/img/product4.svg" alt="Product" />
              </a>
            </div>
            {/* .cs-slide */}
            <div className="cs-slide">
              <a href="#" className="cs-image_box cs-style1">
                <img src="assets/img/product5.svg" alt="Product" />
              </a>
            </div>
            {/* .cs-slide */}
            <div className="cs-slide">
              <a href="#" className="cs-image_box cs-style1">
                <img src="assets/img/product6.svg" alt="Product" />
              </a>
            </div>
            {/* .cs-slide */}
            <div className="cs-slide">
        ...
        {/* .cs-slider_container */}
        <div className="cs-pagination cs-style1 cs-hide_desktop cs-accent_color" />
